...
package org.broadleafcommerce.admin.client.datasource.i18n;
...
public class ProductOptionTranslationMapDataSourceFactory implements DataSourceFactory {
    ...
    public void createDataSource(String name, OperationTypes operationTypes, Object[] additionalItems, AsyncCallback<DataSource> cb) {
        if (dataSource == null) {
            ...
            persistencePerspective.addPersistencePerspectiveItem(PersistencePerspectiveItemType.FOREIGNKEY, new ForeignKey("id", org.broadleafcommerce.admin.client.datasource.EntityImplementations.PRODUCT_OPTION_VALUE, null));
